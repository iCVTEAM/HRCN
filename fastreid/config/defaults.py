...
# Parameters in hrcn head
_C.MODEL.HEADS.GCN_CHANNELS = [512, 512, 512]
_C.MODEL.HEADS.CENTER_POOL_TYPE = "circle"
_C.MODEL.HEADS.KEEP_FIRST = True
_C.MODEL.HEADS.CENTER_NUM = 4
_C.MODEL.HEADS.NODE_LIST = [4, 6, 3]
_C.MODEL.HEADS.BLOCK_NUM_LIST = [4, 6, 3]
_C.MODEL.HEADS.IN_CHANNEL_LIST = [512, 1024, 2048]
_C.MODEL.HEADS.GATE = 1e-2
_C.MODEL.HEADS.FINAL_CHANNEL = [128, 512]
_C.MODEL.HEADS.FINAL_CHANNEL_NUM = [12, 1]
_C.MODEL.HEADS.DROPOUT = False
_C.MODEL.HEADS.LAST_FC_LAYER = False
_C.MODEL.HEADS.REDUCE_DIAG = False
...
_C.MODEL.LOSSES.TRI.WEIGHTS_TYPE = "softmax"
...
_C.SOLVER.MANUAL_SEED_FLAG = False
_C.SOLVER.MANUAL_SEED_NUMBER = 0
