...
class SmallVehicleID(VehicleID):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        super(SmallVehicleID, self).__init__('', self.test_list, **kwargs)
...
class MediumVehicleID(VehicleID):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        super(MediumVehicleID, self).__init__('', self.test_list, **kwargs)
...
class LargeVehicleID(VehicleID):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        super(LargeVehicleID, self).__init__('', self.test_list, **kwargs)
