...
def l2_weights(dist, mask):
    diff = dist * mask
    W = F.normalize(diff, p=2, dim=1)
    return W
...
def weighted_example_mining(dist_mat, is_pos, is_neg, weights_type):
...
class TripletLoss(object):
    ...
    def __init__(self, cfg):
        ...
        self._weights_type = cfg.MODEL.LOSSES.TRI.WEIGHTS_TYPE
    ...
    def __call__(self, embedding, targets):
        ...
        if self._hard_mining:
            ...
            dist_ap, dist_an = weighted_example_mining(dist_mat, is_pos, is_neg, self._weights_type)
